...
model1 = pickle.load(open(working_dir + "/trained_models_trial2/xg_model_log_target_Q1.sav","rb"))
model2 = pickle.load(open(working_dir + "/trained_models_trial2/cb_model_log_target_Q2.sav", 'rb'))
model3 = pickle.load(open(working_dir + "/trained_models_trial2/lg_model_log_target_Q3.sav","rb"))
model4 = pickle.load(open(working_dir + "/trained_models_trial2/hist_model_log_target_Q4.sav","rb"))
#p95
...
meta_model = pickle.load(open(working_dir + "/trained_models_trial2/meta_hist_4_models_log_target_Q1_to_Q4.sav","rb"))
