...
model1 = pickle.load(open(working_dir + "/models/trained_models_trial_1/xg_model_signed_target_Q1.sav","rb"))
model2 = pickle.load(open(working_dir + "/models/trained_models_trial_1/cb_model_signed_target_Q2.sav", 'rb'))
model3 = pickle.load(open(working_dir + "/models/trained_models_trial_1/lg_model_signed_target_Q3.sav","rb"))
model4 = pickle.load(open(working_dir + "/models/trained_models_trial_1/hist_model_signed_target_Q4.sav","rb"))
#p95
model5 = pickle.load(open(working_dir + "/models/trained_models_trial_1/lg95_model_signed_target.sav","rb"))
model6 = pickle.load(open(working_dir + "/models/trained_models_trial_1/hist_model95_signed_target.sav","rb"))
meta_model = pickle.load(open(working_dir + "/models/trained_models_trial_1/meta_hist_4_models_signed_target_p95.sav","rb"))
